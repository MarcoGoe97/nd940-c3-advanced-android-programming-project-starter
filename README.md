...
This project is part of the Android Kotlin Developer Nanodegree Program. The project consists of an app to download a file from Internet by clicking on a custom-built button where:
